...
const Privacy = () => {
    return <section>
        ...
        <div className="G-container G-section-padding">
            ...
            <div className="G-page-text">
                <h3>How We Use AppVim Landing Page Data </h3>
                <p>AppVim SaaS Landing Page Template uses visitors' data for the following general purposes:</p>
                <ol>
                    ...
                    <li>To sell or market AppVim Landing Page products and services to you</li>
            ...
            <div className="G-page-text">
                ...
                <p>AppVim is a HTML landing page template tool. By its nature, Services enable our customers to promote their products and services integrate with hundreds of business applications that they already use, all in one place.</p>
                <p>Services help our customers promote their products and services, marketing and advertising; engaging audiences; scheduling and publishing messages; and analyze the results.</p>
            </div>
            <div className="G-page-text">
                <h3>Consent Of Using AppVim Landing Page    </h3>
